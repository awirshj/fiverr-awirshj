...
// img sources for TrustedBy.svelte component
export const trustedByLogoSrc = readable([
  {
    name: "Facebook",
...
// data for categories slider...home page
export const catCardsData = readable([
  {
    id: 1,
    title: "AI Artists",
